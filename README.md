...
🛠️ Tech Stack
ComponentTechnologyLanguagePythonModelsDistilBERT (fine-tuned), GRU, LSTMNLP LibraryHuggingFace TransformersData ProcessingPandas, NumPyNotebookJupyter Notebook

📊 Model Performance Comparison
ModelF1 ScoreDistilBERT (fine-tuned)0.74 ✅ BestGRU0.63LSTM (baseline)0.56
...
Jupyter Notebook
Installation
bashgit clone https://github.com/Subhadevik/Sarcasam_detection.git
